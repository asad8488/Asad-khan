...
\x1b[92;1m===================================>\x1b[92;1m
\x1b[93;1m Author       \x1b[92;1m=>      \x1b[93;1mASAD CYBER
\x1b[93;1m Whatsapp     \x1b[92;1m=>      \x1b[93;1m+8801926328940
\x1b[93;1m YouTube       \x1b[92;1m=>      \x1b[93;1mASAD Technology channel
\x1b[92;1m===================================>\x1b[92;1m
"""%(h))
		...
		try:
			...
			if "www.facebook.com" in resp.json()["error_msg"]:
				if 'ya' in oprek:
					...
					print('\r%s [ASAD-CP] %s|%s        '%(b,idf,pw))
